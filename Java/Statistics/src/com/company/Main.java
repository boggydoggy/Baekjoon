...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(findMiddle(numbers));
        System.out.println(findHighestFrequency(numbers));
    ...
    public static int findMiddle(int[] num) {
        int middle = num.length / 2;

        return num[middle];
    }

    public static int findHighestFrequency(int[] num) {
        int count, jump, max = 4001, maxCount = 0;
        boolean flag = false;
